...
def eval(env_class, agent, flags, logger, obs_preprocessing):
    ...
    random_action = flags.random_action
    ...
    flags.random_action = random_action
...
if __name__ == "__main__":
    ...
    dummy_env = env_class()
    agent = Baseline(dummy_env.observation_space, dummy_env.action_space, flags, logger=logger)
